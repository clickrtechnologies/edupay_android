...
import com.example.edupay.databinding.ActivitySchoolRegistrationBinding
...
@AndroidEntryPoint
class SchoolRegistrationActivity : BaseActivity() {
    private lateinit var binding: ActivitySchoolRegistrationBinding
    private val viewModel: HomeViewModel by viewModels()
    var myTinyDB: MyTinyDB? = null
    var preferenceHelper: PreferenceHelper? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySchoolRegistrationBinding.inflate(layoutInflater)
        ...
        binding.btnSchoolLogin.setOnClickListener {
            if (validateInputs()) {
                ...
                registeredSchool(email, fullPhoneNumber, binding.ccp.selectedCountryCodeWithPlus)
    ...
    private fun validateInputs(): Boolean {
        ...
        /*   if (schoolName.isEmpty()) {
               binding.etSchoolName.error = "Enter school name"
        ...
        /*   if (!binding.ccp.isValidFullNumber) {
               Toast.makeText(this, "Invalid country code or mobile number", Toast.LENGTH_SHORT).show()
               return false
           }*/
    ...
    private fun registeredSchool(
        ...
        viewModel.registeredSchool(request).observe(this, Observer {
